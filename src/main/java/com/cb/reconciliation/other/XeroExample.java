...
//        final String clientId = "0A33E85DDDB74CA5A5D08A2A178A844A";
//        final String clientSecret = "H6e8vmVWfg73WeI7GQ1ZJupi0Eo4BeNW_TQxA6oMGEzpFUhl";
//        final String callback = "https://developer.xero.com/";
//
//        final String secretState = "secret" + new Random().nextInt(999_999);
//        final OAuth20Service service = new ServiceBuilder(clientId)
//                .apiSecret(clientSecret)
//                .defaultScope("offline_access accounting.transactions openid profile email accounting.contacts accounting.settings") // replace with desired scope
//                .callback(callback)
